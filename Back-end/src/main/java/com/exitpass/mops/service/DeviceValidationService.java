...
// Plain JdbcTemplate instead of full JPA entities for `sites` -- login only
// needs a read-only lookup; the full sites.* entity graph belongs with
// backlog item 1 (Device Identity and Site Binding), not bolted onto auth.
@Service
