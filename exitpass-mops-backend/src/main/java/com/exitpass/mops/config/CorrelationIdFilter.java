...
// Matches the correlation_id convention already present on nearly every
// table in the real schema (mops_transaction_records.correlation_id etc.).
// Propagating it end-to-end here means new endpoints get audit-traceable
// requests for free.
@Component
@Order(1)
